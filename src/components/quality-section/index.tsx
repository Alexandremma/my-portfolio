...
export default function QualitySectionComponent() {
    return (
        <section id="qualities-section" className="relative py-32 px-4 lg:px-20 bg-gradient-to-t from-indigo-500 to-blue-600">
            <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-20">
