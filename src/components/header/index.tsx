...
export default function HeaderComponent() {
    ...
    return (
        <header className={`w-full mx-auto fixed top-0 left-0 z-20 px-8 md:px-12 lg:px-28 py-5 transition duration-700 ${isNavbarScrolled ? 'bg-scrollTransparent' : 'bg-bgTransparent'}`}>
