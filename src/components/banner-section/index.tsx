...
export default function BannerSectionComponent() {
    return (
        <section id="initial-banner-section" className="relative w-full h-screen md:h-[600px] lg:h-[640px] flex flex-col-reverse md:flex-row items-center justify-end md:justify-center pt-16 md:pt-24 px-8 md:px-16 lg:px-28 bg-gradient-to-t from-indigo-500 to-blue-600">
            ...
            <div className="">
                <img className="md:block py-4 md:pt-8 md:pb-0" src={InitialBannerImage} alt="Imagem com desenho de pessoas interagindo com itens de tecnologia" />
            </div>
        </section>
    )
}